<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpstudy_pro\WWW\miniShopFox\miniShopFox\public/../application/admin\view\ad\index.html";i:1593688888;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content">
                                            ...
                                            <tbody>
                                                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <td><img src="/uploads/<?php echo $vo['img']; ?>" alt="<?php echo $vo['title']; ?>" width="160"></td>
                        ...
                        <div id="tab-2" class="tab-pane <?php if(input('tab',1) == 2): ?>active<?php endif; ?>">
                            <div class="panel-body">
                                <form method="post" class="form-horizontal" action="<?php echo url('add'); ?>" data-type="ajax" enctype="multipart/form-data">
                                    <div class="form-group">
                                                    ...
                                                    $("body").delegate("#file_path_edit", 'change', function(){
                                                        ...
                                                        if('gif|jpg|png|bmp'.indexOf(ext)>=0){
                                                            $.ajaxFileUpload({
                                                               ...
                                                               dataType: 'json',
                                                               success: function (data, status) {
                                                                   $('#info_path_edit').val(data.filename);
